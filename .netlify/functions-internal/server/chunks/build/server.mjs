import { defineComponent, ref, shallowRef, watch, hasInjectionContext, inject, h, getCurrentInstance, nextTick, defineAsyncComponent, createElementBlock, Suspense, Fragment, createApp, provide, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, computed, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { l as defuFn, m as klona, h as createError$1, o as hasProtocol, q as isScriptProtocol, r as joinURL, w as withQuery, s as sanitizeStatusCode, t as getContext, $ as $fetch$1, v as baseURL, x as createHooks, y as executeAsync, z as toRouteMatcher, A as createRouter$1, B as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B8Cc2Jb4.mjs')
  },
  {
    name: "chat-department",
    path: "/chat/:department()",
    component: () => import('./_department_-C2A0xDwj.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-uyjXs1eU.mjs').then((r) => r["default"] || r.default || r));
...
const colors_SBYXX91E9RqztO3fCW8gnbitjIPpfm_KGUDAxl_o15U = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  ...
  colors_SBYXX91E9RqztO3fCW8gnbitjIPpfm_KGUDAxl_o15U,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-mJu6G3JX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DR0QXKuH.mjs'));
...
export { Icon as I, _export_sfc as _, useAppConfig as a, useRoute as b, useRouter as c, useNuxtApp as d, entry$1 as default, appConfig as e, useRuntimeConfig as f, nuxtLinkDefaults as g, getIcon as h, asyncDataDefaults as i, createError as j, loadIcon as l, navigateTo as n, resolveRouteObject as r, useHead as u };
